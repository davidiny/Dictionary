...
def index(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'random.html', {'form': form, 'word': answer[0]['word'], 'definition' : answer[0]['text'], 'partOfSpeech' : answer[0]['partOfSpeech']})
    else:
        form = MyForm(request.POST)
    ...
    return render(request, 'random.html', {'form': form, 'word' : answer['word'], 'definition' : answer2[0]['text'], 'partOfSpeech' : answer2[0]['partOfSpeech']})